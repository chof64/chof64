  ...
  return (
    <>
      <div className="flex h-[95vh] flex-col items-center justify-center">
        <div className="w-[75vw] rounded-3xl border border-[#FFFCFF] bg-[#FFFCFF] px-6 py-8 font-medium text-[#50514F] shadow-2xl sm:w-[70vw] md:w-[60vw] lg:max-w-[40vw] xl:max-w-[35vw]">
      ...
      <div className="absolute inset-0 -z-50 h-screen w-screen animate-gradient-xy bg-gradient-to-r from-[#FB8D89] via-[#FEF085] to-[#A9DAC8] blur-3xl" />
    </>
  );
}
